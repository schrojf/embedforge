...
Instructions for AI coding agents working on embedforge.
...
`UV_CONFIG_FILE=uv.toml uv run python -m embedforge`.

## Conventions

- **Layout**: `src/` layout; code in `src/embedforge/`, tests in `tests/`.
